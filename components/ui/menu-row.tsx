...
function MenuRow({
  ...
  return (
    <button
      type={type}
      className={cn(
        'flex w-full items-center gap-3 border-b border-border px-4 py-3.5 text-left outline-none transition-colors last:border-0 hover:bg-muted/50 focus-visible:bg-muted/50 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sage-green/50',
        className
      )}
      {...props}
    >
